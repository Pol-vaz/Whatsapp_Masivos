...
message_text = 'Una de mi clase se quedo ciega'

no_of_message = 100 # no de veces que se repetirá el mensaje

# lista de números de teléfono puede ser de cualquier longitud
moblie_no_list = [34674467233]
...
#AQUÍ DEBES CAMBIAR LA RUTA DONDE ESTE TU CHOMEDRIVER
driver = webdriver.Chrome(executable_path="/home/pol/Escritorio/Whatsapps_Masivos/chromedriver")
